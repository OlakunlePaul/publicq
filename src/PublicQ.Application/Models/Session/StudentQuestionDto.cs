...
/// <summary>
/// Data transfer object representing a question for students during assessment execution.
/// </summary>
public class StudentQuestionDto
{
    ...
    /// <see cref="StudentPossibleAnswersDto"/>
    /// </summary>
    public List<StudentPossibleAnswersDto> Answers { get; set; } = new();
}
