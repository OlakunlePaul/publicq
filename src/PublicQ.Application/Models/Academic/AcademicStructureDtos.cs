...
public record TermDto(Guid Id, Guid SessionId, string SessionName, string Name, DateTime? StartDate, DateTime? EndDate, DateTime? NextTermBegins, bool IsActive, bool IsCumulativeTerm);
public record TermCreateDto(Guid SessionId, string Name, DateTime? StartDate, DateTime? EndDate, DateTime? NextTermBegins, bool IsActive, bool IsCumulativeTerm);
