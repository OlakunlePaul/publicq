...
public record SubjectDto(Guid Id, string Name, string? Code, int DisplayOrder, List<Guid>? ClassLevelIds = null);
...
public record ClassLevelDto(Guid Id, string Name, string? SectionOrArm, int OrderIndex, Guid? GradingSchemaId, List<Guid>? SubjectIds = null);
